...
const apiCalls = function(input) {
  ...
  //Run the classifier function as soon as the input is available
  classifier(input);
...
//restaurant call - house on parliament - GOOD
//https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=43.662905,-79.376897&radius=500&types=restaurant&name=house+on+parliament&key=AIzaSyBbhx8XATrO3bPG8-i1734tvVAdUzaqay4
//cafe call - tim hortons - GOOD
//https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=43.662905,-79.376897&radius=500&types=cafe&name=tim+hortons&key=AIzaSyBbhx8XATrO3bPG8-i1734tvVAdUzaqay4
//book call - harry potter - GOOD
//https://www.googleapis.com/books/v1/volumes?q=intitle:harry+potter&printType=books&key=AIzaSyBbhx8XATrO3bPG8-i1734tvVAdUzaqay4
//film call - the power of the dog - GOOD
//http://www.omdbapi.com/?t=the+power+of+the+dog&apikey=2e288a92
//product call - eggs - GOOD
//https://api.spoonacular.com/food/ingredients/search?query=eggs&number=1&apiKey=7808b0b61fe44e1bb48e723c7fbaefac
